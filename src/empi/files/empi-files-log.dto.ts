...
export const EmpiFilesLogObject: EntityObject = {
  tableName: 'EMPI.EMPI_FILES_LOG',
  primaryKeyId: 'ID',
  seqName: 'EMPI.EMPI_FILES_LOG_SEQ',
};

export const EmpiFilesLogEntity = {
    ID: { type: 'number' },
